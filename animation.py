...
def simulate(model,passengerlist,floornum):
    ...
    for t in range(1800):
        ...
        #         logits[5] = 0
        #         logits[7] = 0
        people_on_each_floor = [0]*floornum
        for i in range(floornum):
            people_on_each_floor[i] = len(floorlist[i])
        eui.animate_elevator(people_on_each_floor, floornum, elevator1, elevator2,elevator1d,elevator2d)
